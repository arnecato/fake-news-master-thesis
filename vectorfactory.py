...
def main():
    ...
    fasttext_fac.vectorize_dataframe('dataset/ISOT/True.csv', 'dataset/ISOT/True_vectorized_spacy_fasttext.h5', ['title', 'text'])
    fasttext_fac.vectorize_dataframe('dataset/ISOT/Fake.csv', 'dataset/ISOT/Fake_vectorized_spacy_fasttext.h5', ['title', 'text'])
